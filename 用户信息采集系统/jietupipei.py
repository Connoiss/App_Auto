...
class APP:
    ...
    def sizhou(self, a):
        ...
        name = a
        send(44)
        mouse.click(button="left", coords=(1860, 70))  # 键盘设置
        mouse.click(button="left", coords=(1800, 135)) # 选择预设配置
        mouse.click(button="left", coords=(1800, 165)) # 4K
        mouse.click(button="left", coords=(1825, 750)) # Save
    ...
    def liuzhou(self, a):
        ...
        mouse.click(button="left", coords=(1860,70))    # 键盘设置
        mouse.click(button="left", coords=(1800, 135))  # 选择预设配置
        mouse.click(button="left", coords=(1800, 200))  # 6K
        mouse.click(button="left", coords=(1825, 750))  # Save
    ...
    def jiuzhou(self, a):
        ...
        mouse.click(button="left", coords=(1860, 70))  # 键盘设置
        mouse.click(button="left", coords=(1800, 135))  # 选择预设配置
        mouse.click(button="left", coords=(1800, 235))  # 9K
        mouse.click(button="left", coords=(1825, 750))  # Save
    ...
    def jietu(self, a):
        ...
        Completion_degree_img = pyautogui.screenshot(region=[1520, 270, 100, 50])
